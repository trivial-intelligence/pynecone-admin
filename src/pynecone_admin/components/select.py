"""
The built-in Chakra UI select component < pynecone 0.1.32.

Newer versions of pynecone depend on chakra-react-select and do not seem to
handle the `value` binding for a fully controlled input, so the previous
working component is vendored here.
"""
